...
import { Loader2, Mail, Phone, MapPin, Calendar, Eye, EyeOff, User2, User } from "lucide-react";
...
const [visibleProfile, setVisibleProfile] = useState(1)
  ...
  const profile_content = (
    ...
    <div className="text-white p-4 mb-20 flex flex-row gap-5">
  ...
  //         </div>
  //         <div className={`${visibleProfile === 5 ? 'block' : 'hidden'}`}>
  //         <ProfilePage  />
  //         </div>
  return(
    <div>
