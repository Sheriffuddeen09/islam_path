...
export default function TeacherAssignmentPreview() {
 ...
 const toggleBlock = async (assignment) => {
  ...
  const content = (
     <div className="overflow-x-auto max-h-[70vh] no-scrollbar border rounded-lg shadow-md w-80 scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-100">
