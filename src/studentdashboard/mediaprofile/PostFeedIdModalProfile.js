...
const shareToChat = async (chatId) => {
  ...
  return (
    <div className="fixed px-2 inset-0 bg-black/90 flex sm:py-5 items-center justify-center z-50">
      <div className="bg-[var(----bg-color)] text-[var(----text-color)] rounded-xl w-full h-full sm:my-4 flex flex-col py-3 max-w-xl border shadow-lg">
        ...
        scrollbar scrollbar-thumb-gray-200 scrollbar-track-transparent scrollbar-thin  overflow-x-hidden p-4 sm:h-[400px] h-[300px] relative ">
          {/* User info */}
        ...
        {/* Reaction Count setShowUsersPopup Like */}
       ...
       <div className=" text-xs inline-flex items-center gap-2 bg-[var(----bg-color)] text-[var(----text-color)]">
        ...
        {total > 0 && (
  <div className="text-xs flex items-center gap-1 cursor-pointer bg-[var(----bg-color)] text-[var(----text-color)]">
    ...
    {others.length > 1 && (
      ...
      <div className="inline-flex items-center gap-3 bg-[var(----bg-color)] text-[var(----text-color)]">

        <p className="inline-flex gap-1 items-center bg-[var(----bg-color)] text-[var(----text-color)]">
      {post.comments_count}
      ...
      {post.shares_count}
           <svg
            ...
            viewBox="0 0 24 24"
            fill="currentColor"
            className="w-5 h-5bg-[var(----bg-color)] text-[var(----text-color)]"
          >
    ...
    {/* Reactions */}
    <div className="flex items-center justify-around py- text-smbg-[var(----bg-color)] text-[var(----text-color)]">
                  <div className="flex justify-betweenbg-[var(----bg-color)] text-[var(----text-color)] mx-4">
                ...
                <div className="relative group hover:text-blue-800  inline-block" onMouseEnter={() => setShowReactions(true)} onMouseLeave={() => setShowReactions(false)}>
                  ...
                  <button onClick={onLikeClick}
                          className={`flex items-center font-semibold ${myReaction ? 'font-bold text-blue-900 p-1 ' : 'bg-[var(----bg-color)] text-[var(----text-color)]'}`}>
                  ...
                  <button className="flex items-center font-semibold bg-[var(----bg-color)] text-[var(----text-color)]" onClick={focusCommentInput}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 20.25c4.97 0 9-3.694 9-8.25s-4.03-8.25-9-8.25S3 7.444 3 12c0 2.104.859 4.023 2.273 5.48.432.447.74 1.04.586 1.641a4.483 4.483 0 0 1-.923 1.785A5.969 5.969 0 0 0 6 21c1.282 0 2.47-.402 3.445-1.087.81.22 1.668.337 2.555.337Z" />
                    </svg> Comment
                  </button>

                   <button onClick={() => setShares(!shares)} className="flex items-center font-semibold gap-1 mx-4 bg-[var(----bg-color)] text-[var(----text-color)]">
                    <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                    fill="currentColor"
