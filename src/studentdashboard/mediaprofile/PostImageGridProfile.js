...
setEditContent, setSelectedPost, setShowDeleteModal, setShowEditModal,selectedPost, loadingProfile,
    ...
    return (
      <>
        <div className="grid grid-cols-2 gap-1 w-full">
          <img
            src={media[0].url}
            className="row-span-2 h-full w-full object-cover rounded cursor-pointer"
            onClick={() => openPreview(0)}
          />
