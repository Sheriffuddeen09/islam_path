...
export default function AttachmentMenuCommunity({ show, onClose, onPick }) {
  ...
  return (
    ...
    >
      <div className="bg-black/90 p-5 rounded-2xl grid grid-cols-2 gap-6 text-white shadow-xl backdrop-blur-md">
