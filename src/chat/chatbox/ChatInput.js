    ...
    <div className="px w-full bg-[var(--bg-color)]  sm:gap-3 gap-1 flex items-center flex-row sm:p-2">
      ...
      <div className="relative w-full mt-1">
       <textarea
              ...
              className="flex-1 border no-scrollbar bg-[var(--bg-color)] border-gray-400 
               scrollbar-thin scrollbar-thumb-gray-200 scrollbar-track-transparent
              text-[var(--text-color)] shadow relative w-full px-4 rounded-full py-3 relative"
          />
      ...
      {!recording && text && (
          <button onClick={sendText} className="text-white bg-green-500  px-2 py-2 rounded-full">
