    ...
    <div className="relative">
      ...
      {!recording && !audioUrl && (
        <button onClick={startRecording}>
           <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"  className="sm:w-6 sm:h-6 w-4 h-4 text-black hover:text-gray-600">
      ...
      {recording && (
        ...
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"  className=" w-8 h-8 p-1 rounded-2xl text-white bg-red-500 px- py-" onClick={stopRecording}>
