...
const content = (
     <div className="overflow-x-auto max-h-[70vh] no-scrollbar border rounded-lg shadow-md -full scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-100">
