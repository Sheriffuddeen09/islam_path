...
export default function TeacherExamPreview() {
 ...
 const toggleBlock = async (exam) => {
  ...
  const content = (
     <div className="overflow-x-auto max-h-[70vh] border no-scrollbar rounded-lg shadow-md sm:w-full w-80  scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-100">
