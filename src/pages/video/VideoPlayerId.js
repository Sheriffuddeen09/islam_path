...
const toggleReaction = async (emoji) => {
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="m4.5 15.75 7.5-7.5 7.5 7.5" />
      ...
      >
        ...
        <div className="absolute flex flex-col items-center  top-1/2 left-1/2 translate-x-28 -translate-y-1/2 z-50 pointer-events-auto">
      <button onClick={() => toggleReaction("👍")} className="mt-2 px-3 py-1 text-white rounded inline-flex items-end gap-1">
