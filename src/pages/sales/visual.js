...
export default function VirtualizedCategoryCarousels() {
              ...
              return (
                <div key={parent.id} className="mb-12">
                  <div className="flex justify-between items-center mb-4">
                    ...
                    <button className="text-blue-600 font-semibold hover:underline">See All</button>
                  </div>
                      ...
                      return (
                        <div key={child.id} className="mb-8">
                          <div className="flex justify-between items-center mb-2">
                            ...
                            <button className="text-blue-500 font-semibold hover:underline">See All</button>
                          </div>
  ...
  return (
    <div className="relative bg-white p-2 rounded-lg shadow hover:shadow-lg transition group">
      ...
      <div className="absolute top-2 right-2 opacity-0 group-hover:opacity-100 transition flex flex-col gap-2">
        <button onClick={() => console.log("Add to wishlist", product.id)} className="bg-gray-800 p-2 rounded shadow hover:bg-gray-600">
