...
export default function PostCommentItem({setIsDeleting, setIsEdit, isEdit, isDeleting, v, comment, onReplyAdded, onDelete,handleEditReply, handleDeleteReply, updateCommentTree, setComments }) {
