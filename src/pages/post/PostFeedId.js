...
export function PostFeedId({ postId, post, user, total, others, setShowUsersPopup, me, 
                                  showUsersPopup, currentUser, allUsers, getColor, counts, setShowReactions,
    ...
    <div>
      <div className="bg-white text-black rounded-xl w-full h-full sm:my-4 flex flex-col py-3 max-w-xl border shadow-lg">
        ...
        <div className="flex-1 overflow-y-auto overflow-x-hidden p-4 sm:h-[400px] h-[300px] relative ">
          {/* User info */}
          <div className="flex justify-between items-center gap-2 px-3 mb-5">
